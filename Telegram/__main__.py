...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module(f"Telegram.modules.{module_name}")
...
if __name__ == "__main__":
    log.info(f"[TELEGRAM] Successfully loaded modules: {str(ALL_MODULES)}")
